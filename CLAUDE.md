...
**Resolved:** the stale "full spec in the original..." pointers in `docs/PHASE0_PROJECTS.md`'s stretch section were removed at Kacper's request — the short specs there are enough to start; he'll ask for a fuller spec when he's actually ready to build a stretch project, rather than us maintaining dead references to deleted content.
